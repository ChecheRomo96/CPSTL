    ...
    namespace cpstd{
        ...
        struct is_floating_point {
            static constexpr bool value =
                cpstd::is_same<cpstd::remove_cv<T>::type, float>::value ||
                cpstd::is_same<cpstd::remove_cv<T>::type, double>::value ||
                cpstd::is_same<cpstd::remove_cv<T>::type, long double>::value;
        };
